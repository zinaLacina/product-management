package com.zina.microservices.composite.product.services;
...
public class ProductCompositeServiceImpl implements ProductCompositeService {
    ...
    public Mono<Void> createCompositeProduct(ProductAggregate body) {
        return ReactiveSecurityContextHolder.getContext().doOnSuccess(sc -> internalCreateCompositeProduct(sc, body))
                .then();
    }
    ...
    public Mono<ProductAggregate> getCompositeProduct(int productId, int delay, int faultPercent) {
        ...
        return Mono
                .zip(values -> createProductAggregate((SecurityContext) values[0], (Product) values[1],
    ...
    private ProductAggregate createProductAggregate(SecurityContext sc, Product product,
