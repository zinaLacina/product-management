package com.zina.microservices.core.recommendation.services;
...
import com.zina.microservices.core.recommendation.persistence.RecommendationEntity;
...
public class RecommendationServiceImpl implements RecommendationService {
    ...
    public Flux<Recommendation> getRecommendations(int productId) {
        ...
        return repository.findByProductId(productId).log().map(e -> mapper.entityToApi(e)).map(e -> {
