package com.zina.microservices.core.product.services;
...
import com.zina.microservices.core.product.persistence.ProductEntity;
...
public class ProductServiceImpl implements ProductService {
    ...
    public Product createProduct(Product body) {
        ...
        Mono<Product> newEntity = repository.save(entity).log()
    ...
    public Mono<Product> getProduct(int productId) {
        ...
        return repository.findByProductId(productId)
                .switchIfEmpty(error(new NotFoundException("No product found for productId: " + productId))).log()
